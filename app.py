...
# calculate intensity (kgCO2e per tonne)
em_col = f"Emissions_{unit_label}"

# convert back to kgCO2e if needed
unit_multipliers = {
    "kgCO2e": 1,
    "tCO2e": 1000,
    "ktCO2e": 1_000_000,
    "MtCO2e": 1_000_000_000,
}

summ["EmissionIntensity_kgCO2e_per_t"] = (
    summ[em_col] * unit_multipliers[unit_label] / summ["TotalTonnes"]
)
# display table
st.dataframe(
    summ[["scenario","EmissionIntensity_kgCO2e_per_t"]]
    .round(2),
